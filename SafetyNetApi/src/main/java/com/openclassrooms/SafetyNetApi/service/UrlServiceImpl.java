...
import com.openclassrooms.SafetyNetApi.repository.UrlRepository;


import java.util.ArrayList;
import java.util.List;

public class UrlServiceImpl implements UrlRepository {
    ...
    public List<ChildAlertDTO> getChildListByAdress(String address) {
        ...
        PersonServiceImpl personRepository = new PersonServiceImpl();
    ...
    public List<PersonInfoDTO> getPersonListInfo(String firstName, String lastName) {
        ...
        PersonServiceImpl personRepositoryImpl = new PersonServiceImpl();
        MedicalRecordServiceImpl medicalRecordImpl = new MedicalRecordServiceImpl();
    ...
    public PhoneAlertDTO getPhoneNumberListByStation(String station) {
        ...
        FireStationServiceImpl fireStationImpl = new FireStationServiceImpl();
    ...
    public FirestationAdressListDTO getPersonListByAddress(String address) {
        ...
        for (Person person : listPerson) {
            ...
            MedicalRecordServiceImpl medicalRecord = new MedicalRecordServiceImpl();
